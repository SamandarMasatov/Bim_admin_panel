  ...
  <div>
    <div class="pa-5">
        <div v-if="datas.length == 0">
          <h3 class="mt-5">O'qituvchilar yo'q</h3>
          <v-btn class="info mt-3" to="/AddTeam">O'qituvchi qo'shish</v-btn>
        </div>
      <div
      ...
      >
        ...
        <v-row class="my-5">
          <v-col cols="12" md="5">
            ...
            <v-img
              width="100%"
              :src="`http://localhost:3030/uploads/team/${data.image}`"
            ></v-img>
          </v-col>
          <v-col cols="12" md="7">
            <v-row>
    ...
    <UpdateTeam v-if="addModal" :ID="id" @Close="close()" @Updated="updated()" />
  </div>
</template>
